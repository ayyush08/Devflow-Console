...
export default function Navbar() {
    ...
    return (
        <div className="w-full justify-between p-5 px-12 top-0 left-0 right-0 z-10 fixed flex mb-5">
            <Link className=" text-2xl font-bold text-white" href='/'>{APP_NAME}</Link>
